        ...
        <div class="modal-content">
            <form id="edit-facility" method="POST" action="./database/add_controller/private_facility.php" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" class="form-control" name="type" id="type" value="government_human">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="row mt-lg-3">
                <div class="col-lg-12 d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="">Edit the private-human premises</h4>
                    </div>
                    <div>
                ...
                <div class="col-lg-12 col-12">
                    <div class="table-responsive">
                        <table class="table table-bordered caption-top shadow" id="myTable">
                            <caption>Question goverment</caption>
                            ...
                            <tbody>
                                <?php
                     $number = 1;
                     $results_facilty = $db_inspection->fetch_facility_p_h();
                    ...
                    ?>
                                ...
                                <?php 
                        include './Modal/facility_p_h.php';
                        $number++;
                     }
                     ?>
                            </tbody>
    ...
    $('.delete_button').click(function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "./database/delete_controller/delete_private_facility.php",
                    data: {
