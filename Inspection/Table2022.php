    ...
    <table class="table table-hover">
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                    <a  class="btn btn-primary" href="./Report/instant_report_gov2022.php?inspection_id=<?php echo $row["inspection_id"]; ?>&id=<?php echo $row["id"]; ?>" >
                        Report
                    </a>
                </td>
            </tr>
    ...
    <table class="table table-hover ">
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                    <a  class="btn btn-primary" href="./Report/instant_report_pri2022.php?inspection_id=<?php echo $row["inspection_id"]; ?>&id=<?php echo $row["id"]; ?>" >
                        Report
                    </a>
                </td>
            </tr>
