...
$g_2021 = ($db->result_financial_2021_g())[0]['Sum']+($db->result_financial_2021_g())[1]['Sum'];
$g_2022 = ($db->result_financial_2022_g_1())[0]['Sum']+($db->result_financial_2022_g_2())['Sum'];
...
$p_2022 = ($db->result_financial_2022_p_1())[0]['Sum']+($db->result_financial_2022_p_2())['Sum'];
