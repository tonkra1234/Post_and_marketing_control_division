            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-floating mb-3">
                            <select class="form-select" aria-label="Default select example" id="Category_of_premises"
                                name="Category_of_premises" required>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-floating mb-3">
                            <select class="form-select" aria-label="Default select example" id="type_of_premises"
                                name="type_of_premises" required>
                                <option value="">Select one of these</option>
