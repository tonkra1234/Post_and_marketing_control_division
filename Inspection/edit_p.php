...
$db = new Database();
$fetch_each_data_p = $db->fetch_each_data_p($inspection_id);
$count_question = json_decode($fetch_each_data_p['check_list']);
?>
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" id="count_question" name="count_question" value="<?php echo count($count_question);?>">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="Inspec_id" name="Inspec_id"
                                    value="<?php echo $fetch_each_data_p['inspection_id'];?>">
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="input-group mb-3">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="input-group mb-3">
                                ...
                                <textarea class="form-control" aria-label="Address of the premise" rows="3"
                                    name="address"><?php echo $fetch_each_data_p['address_of_premise'];?></textarea>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php 
                            $results = json_decode($fetch_each_data_p['check_list']);
                            $number = 1;
