...
$result_check_g_h_now = $db->result_check_g_h_now();
$Number_g_h_now=[];
$total_question_g_h_now = [];
foreach ($result_check_g_h_now as $row ){
    for ($i=1; $i <= count(json_decode($row['check_list'])); $i++) { 
        array_push($total_question_g_h_now, $i);
        if((json_decode($row['check_list']))[$i-1][0] === 'No'){
            array_push($Number_g_h_now, $i-1);
        }
    }
};

$total_number_g_h_now = count($result_check_g_h_now)*count($total_question_g_h_now );
if ($total_number_g_h_now === 0) {
    $total_number_g_h_now = 1;
} else {
    $total_number_g_h_now = count($result_check_g_h_now)*count($total_question_g_h_now );
}
$government_h_score_2023 = number_format(100-((count($Number_g_h_now)/($total_number_g_h_now))*100),1);

$result_check_g_v_now = $db->result_check_g_v_now();
$Number_g_v_now=[];
$total_question_g_v_now = [];
foreach ($result_check_g_v_now as $row ){
    for ($i=1; $i <= count(json_decode($row['check_list'])); $i++) { 
        array_push($total_question_g_v_now, $i);
        if((json_decode($row['check_list']))[$i-1][0] === 'No'){
            array_push($Number_g_v_now, $i-1);
        }
    }
};

$total_number_g_v_now = count($result_check_g_v_now)*count($total_question_g_v_now );
if ($total_number_g_v_now === 0) {
    $total_number_g_v_now = 1;
} else {
    $total_number_g_v_now = count($result_check_g_v_now)*count($total_question_g_v_now );
}
$government_v_score_2023 = number_format(100-((count($Number_g_v_now)/($total_number_g_v_now))*100),1);
...
$result_check_g_h_2024 = $db->result_check_g_h_2024();
$Number_g_h_2024=[];
$total_question_g_h_2024 = [];
foreach ($result_check_g_h_2024 as $row ){
    for ($i=1; $i <= count(json_decode($row['check_list'])); $i++) { 
        array_push($total_question_g_h_2024, $i);
        if((json_decode($row['check_list']))[$i-1][0] === 'No'){
            array_push($Number_g_h_2024, $i-1);
        }
    }
};

$total_number_g_h_2024 = count($result_check_g_h_2024)*count($total_question_g_h_2024 );
if ($total_number_g_h_2024 === 0) {
    $total_number_g_h_2024 = 1;
} else {
    $total_number_g_h_2024 = count($result_check_g_h_2024)*count($total_question_g_h_2024 );
}
$government_score_h_2024 = number_format(100-((count($Number_g_h_2024)/($total_number_g_h_2024))*100),1);

$result_check_g_v_2024 = $db->result_check_g_v_2024();
$Number_g_v_2024=[];
$total_question_g_v_2024 = [];
foreach ($result_check_g_v_2024 as $row ){
    for ($i=1; $i <= count(json_decode($row['check_list'])); $i++) { 
        array_push($total_question_g_v_2024, $i);
        if((json_decode($row['check_list']))[$i-1][0] === 'No'){
            array_push($Number_g_v_2024, $i-1);
        }
    }
};

$total_number_g_v_2024 = count($result_check_g_v_2024)*count($total_question_g_v_2024 );
if ($total_number_g_v_2024 === 0) {
    $total_number_g_v_2024 = 1;
} else {
    $total_number_g_v_2024 = count($result_check_g_v_2024)*count($total_question_g_v_2024 );
}
$government_score_v_2024 = number_format(100-((count($Number_g_v_2024)/($total_number_g_v_2024))*100),1);
...
$label_score = ['Private','Government human','Government veterinary'];
...
$score_2020 = [number_format(array_sum($private_2020)/count($private_2020),1),95.43,95.27];
$score_2021 = [number_format(array_sum($private_2021)/count($private_2021),1),96.16,95.54];
$score_2022 = [$private_2022,96.42,95.27];
$score_2023 = [$private_score_2023,$government_h_score_2023,$government_v_score_2023];
$score_2024 = [$private_score_2024,$government_score_h_2024,$government_score_v_2024];
?>