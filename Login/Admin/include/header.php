...
$email = $_SESSION['email_pmcd'];
$_SESSION['email_pmcd'] = $email;
...
<body>
   <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="./admin_page.php"><i class="fa-solid fa-user-nurse me-2"></i>
         Post and Marketing Control</a>
         ...
         <div class="navbar-nav user-photo ms-1 me-auto d-md-none d-lg-block text-start">
            <div class="nav-item text-nowrap">
               <div class="nav-link px-3">
                  <div class="d-flex">
                     <img class="rounded-3 my-auto" src="./image/Officer_image/question_mark.png" alt="Users" style="height: 35px;width:auto;">
                     <div class="ms-3">
