<div class="modal fade" tabindex="-1" id="edit_facility<?php echo $result['id'];?>" aria-labelledby="edit_facility">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="edit-facility" method="POST" action="./database/edit_controller/private_facility.php"
                enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit_question">Edit private-human Facilty</h5>
