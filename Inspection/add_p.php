...
$db = new Database();
$last_id = $db->report2023_pNumber();
?>
<div class="d-flex align-items-center justify-content-center my-5" style="min-height: 70vh;">
    <div class="card shadow">
        <form action="./database/add_SQL_p.php" method="post">
            <div class="card-header bg-primary">
                <h3 class="text-center text-white fw-bold">Private inspection</h3>
            </div>
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="Inspec_id" name="Inspec_id"
                                    value="IN/<?php echo $year?>/P/<?php echo $last_id['next_id']?>">
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="input-group mb-3">
