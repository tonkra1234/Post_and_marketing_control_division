                            ...
                            <td>
                                <div class="d-grid">
                                    <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                        data-bs-target="#Now_g<?php echo $result["id"]; ?>">
                                        Detail
                                    </button>
                                </div>
                            </td>
            ...
            <div class="table-responsive">
                <table class="table table-bordered caption-top shadow">
                    ...
                    <tbody>
                        <?php
                     $number = 1;
                     $results_question = $db_inspection->fetch_question_g();
                    ...
                    ?>
                        ...
                        <?php 
                        include './Modal/question_edit_inspection_modal_g.php';
                        $number++;
                     }
                     ?>
                    </tbody>
    ...
    $('.delete_button').click(function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type :"POST",
                    url : "./database/delete_controller/delete_inspection_g.php",
                    data : {
